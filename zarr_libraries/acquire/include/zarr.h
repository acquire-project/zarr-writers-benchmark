 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStreamSettings_set_s3_bucket_name(ZarrStreamSettings *settings,
...
ZarrError ZarrStreamSettings_set_s3_secret_access_key(
    ZarrStreamSettings *settings, const char *s3_secret_access_key,
 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStreamSettings_set_compression_codec(ZarrStreamSettings *settings,
 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStreamSettings_set_compression_level(ZarrStreamSettings *settings,
 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStreamSettings_reserve_dimensions(ZarrStreamSettings *settings,
                                                size_t count);
 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStreamSettings_set_dimension(
    ZarrStreamSettings *settings, size_t index, const char *name,
    size_t bytes_of_name, ZarrDimensionType kind, uint32_t array_size_px,
...
ZarrError ZarrStreamSettings_get_dimension(
    const ZarrStreamSettings *settings, size_t index, char *name,
    size_t bytes_of_name, ZarrDimensionType *kind, size_t *array_size_px,
    size_t *chunk_size_px, size_t *shard_size_chunks);

uint8_t ZarrStreamSettings_get_multiscale(const ZarrStreamSettings *settings);
...
typedef enum { ZarrVersion_2 = 2, ZarrVersion_3, ZarrVersionCount } ZarrVersion;
 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStream_append(ZarrStream *stream, const void *data,
...
ZarrCompressionCodec ZarrStream_get_compression_codec(const ZarrStream *stream);
 ...
 * @return ZarrError_Success on success, or an error code on failure.
 */
ZarrError ZarrStream_get_dimension(ZarrStream *stream, size_t index, char *name,
                                   size_t bytes_of_name,
                                   ZarrDimensionType *kind,
                                   size_t *array_size_px, size_t *chunk_size_px,
